...
public class UserSessionControllerTests extends BaseControllerTests {
	@Autowired
	...
	public void setup() {
		// 设置测试Controller
		setupController(userSessionController);
	...
	public void getSave() throws Exception { 
		String url = "/a/tl/userSession/save";
		UserSession userSession = new UserSession();
		//userSession.setId("1");//自定义id
		//userSession.setIsNewRecord(true);// 修改默认为新对象的标识，和自定义id配合使用
		//userSession.setName("测试内容");
		 

		// 发送POST请求
		ResultActions resultAction = post(url, JsonMapper.toJsonString(userSession));// "{\"id\":\"1\",\"name\":\"测试内容\"}"
		// 返回200
	...
	public void get() throws Exception {
		String url = "/a/tl/userSession/get";
		// 发送GET请求
