...
<div class="BoxWrap">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/user/form?id=${user.id}">用户 -  <shiro:hasPermission name="sys:user:edit">${not empty user.id?'修改':'新增'}</shiro:hasPermission><shiro:lacksPermission name="sys:user:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<div class="divWrapMarginTop">
		...
		<form:form id="inputForm" modelAttribute="user"
			...
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect3 id="company" name="company.id"
			...
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect3 id="office" name="office.id"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="birthday" type="text" readonly="readonly" style="width: 206px;"
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:select path="post">
						...
						<form:options items="${fns:getDictList('post')}"
							itemLabel="label" itemValue="value" htmlEscape="false" />
					</form:select>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<form:select path="level">
						<form:option value="" label="--请选择--" />
						<form:options items="${fns:getDictList('technical_level')}"
							itemLabel="label" itemValue="value" htmlEscape="false" />
					</form:select>
				</div>
			</div>
			...
			<div class="form-actions">
				...
				<input id="btnCancel" class="Btn btn-blue" type="button" value="返回"
