	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/sys/menu/form?id=${menu.id}&parent.id=${menu.parent.id}">菜单 - <shiro:hasPermission
					name="sys:menu:edit">${not empty menu.id?'修改':'新增'}</shiro:hasPermission>
	...
	<div class="divWrapMarginTop">
		<form:form id="inputForm" modelAttribute="menu"
			...
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect3 id="menu" name="parent.id"
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:radiobuttons path="type"
						items="${fns:getDictList('menu_author_type')}" itemLabel="label"
						itemValue="value" htmlEscape="false" class="required" />
					<span class="help-inline">是否默认授权给每个租户</span>
				</div>
			</div>
			<div class="control-group">
