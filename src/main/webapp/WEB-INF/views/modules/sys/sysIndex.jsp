...
<body>
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand img-brand">
					<img class="logo" src="${ctxStatic}/images/em/logo.png" />
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="themeSwitch" class="dropdown hide"><a
					...
					<li><a href="${ctx}/logout" title="退出登录">退出</a>
					</li>
					<li>&nbsp;</li>
				</ul>
		...
		<div id="footer" class="row-fluid">
			...
			${fns:getConfig('productName')} &nbsp;${fns:getConfig('version')} - Powered By <a
				href="http://www.gzruimin.com" target="_blank">${fns:getConfig('productSupport')}</a> &nbsp;&nbsp;${fns:getConfig('registeNO')}
		</div>
	</div>
	<script type="text/javascript"> 
