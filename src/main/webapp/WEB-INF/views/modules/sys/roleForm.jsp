...
<div class="BoxWrap minHeight">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/role/form?id=${role.id}">角色 -
				<shiro:hasPermission name="sys:role:edit">${not empty role.id?'修改':'新增'}</shiro:hasPermission>
				<shiro:lacksPermission name="sys:role:edit">查看</shiro:lacksPermission>
		</a>
		</li>
	</ul>
	<br />
	<div class="divWrapMarginTop">
		...
		<form:form id="inputForm" modelAttribute="role"
			...
			<div class="control-group"
				<c:if test="${!fns:getUser().admin}">style="display:none"</c:if>>
