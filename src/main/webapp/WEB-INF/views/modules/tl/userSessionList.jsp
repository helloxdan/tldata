...
<body>
	...
	<div class="box box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">用户会话列表</h3>
			</div>
	<form:form id="searchForm" modelAttribute="userSession" action="${ctx}/tl/userSession/" method="post" class="form-inline form-search">
		...
		<div class="cxtj">
			...
			<div class="form-group cxtj_text"><label>用户名称：</label>
	...
	<div class=" addData">
		<div class="box box-solid minHeight">
			<div class="form-group cxtj_text">
				<a href="${ctx}/tl/userSession/form" class="btn btn-blue">新增</a>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		<c:forEach items="${page.list}" var="userSession">
			<tr>
				<td><input type="checkbox" id="select-${userSession.id}"
								class="list_checkbox" value="${userSession.id}" />
				</td>
				<td><a href="${ctx}/tl/userSession/form?id=${userSession.id}">
					${userSession.account}
				</a></td>
				<td>
					${userSession.userid}
