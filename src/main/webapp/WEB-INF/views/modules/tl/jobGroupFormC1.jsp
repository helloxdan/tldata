...
<body>
	...
	<form:form id="inputForm" modelAttribute="jobGroup" action="${ctx}/tl/jobGroup/save" method="post" class="form-horizontal">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">群组link：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">用户数量：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">抽取数据的索引偏移数：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
