...
<body>
	...
	<form:form id="inputForm" modelAttribute="jobUser" action="${ctx}/tl/jobUser/save" method="post" class="form-horizontal">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">用户来源群组：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">用户ID：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">访问码：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
		...
		<div class="col-md-12">
			<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-ls-2 col-xs-2">是否已邀请：</label>
			<div class="col-md-8 col-sm-8 col-ls-8 col-xs-8">
