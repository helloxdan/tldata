...
<div class="BoxWrap minHeight">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/gen/genTable/form?id=${genTable.id}&name=${genTable.name}">业务表
				- <shiro:hasPermission name="gen:genTable:edit">${not empty genTable.id?'修改':'新增'}</shiro:hasPermission>
					...
					<div class="control-group">
						...
						<div class="form-actions">
							<input id="btnSubmit" class="Btn btn-blue" type="submit"
								value="下一步" />&nbsp; <input id="btnCancel" class="Btn btn-blue"
							...
							<div class="controls">
								...
								<form:select path="parentTableFk" cssClass="input-xlarge">
									...
									<form:options items="${genTable.columnList}"
										itemLabel="nameAndComments" itemValue="name"
										htmlEscape="false" />
								</form:select>
