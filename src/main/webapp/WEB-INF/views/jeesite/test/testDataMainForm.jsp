...
<body>
<div class="BoxWrap minHeight content">
	<ul class="nav nav-tabs">

		<li class="active"><a
			href="${ctx}/test/testDataMain/form?id=${testDataMain.id}">主子表 -
				<shiro:hasPermission name="test:testDataMain:edit">${not empty testDataMain.id?'修改':'新增'}</shiro:hasPermission>
				<shiro:lacksPermission name="test:testDataMain:edit">查看</shiro:lacksPermission>
		</a>
		</li>
	</ul>
	<br />
	<div class="divWrapMarginTop box box-solid">
		<form:form id="inputForm" modelAttribute="testDataMain"
			...
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect3 id="user" name="user.id"
			...
			<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect3 id="area" name="area.id"
					...
					<script type="text/template" id="testDataChildTpl">//<!--
						<tr id="testDataChildList{{idx}}">
							...
							<shiro:hasPermission name="test:testDataMain:edit"><td class="text-center" width="10">
								{{#delBtn}}<span class="closeBtn" onclick="delRow(this, '#testDataChildList{{idx}}')" title="删除">&times;</span>{{/delBtn}}
