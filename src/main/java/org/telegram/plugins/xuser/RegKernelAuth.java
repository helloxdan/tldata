 ...
 * @date 13.03.14
 */
public class RegKernelAuth extends KernelAuth {
	...
	public void createNextCodeTimer(int timeout) {
	...
	public JSONObject setRegAuthCode(String code) {
